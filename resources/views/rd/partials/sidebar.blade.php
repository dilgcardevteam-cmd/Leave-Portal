<aside class="hr-sidebar hidden min-h-[calc(100vh-4rem)] bg-gradient-to-b from-[#1c2a5c] to-[#17254f] p-4 text-white lg:block">
    ...
    <nav class="space-y-2" aria-label="RD sidebar">
        <a href="{{ route('rd.index') }}" class="flex items-center rounded-xl py-3 text-lg transition @if(request()->routeIs('rd.index')) bg-white/10 shadow-inner @else hover:bg-white/10 @endif focus:outline-none focus:ring-0" :class="sidebarCollapsed ? 'justify-center px-3' : 'gap-3 px-4'" @if(request()->routeIs('rd.index')) aria-current="page" @endif title="Dashboard">
        ...
        <a href="{{ route('rd.leaves') }}" class="flex items-center rounded-xl py-3 text-lg transition @if(request()->routeIs('rd.leaves*')) bg-white/10 shadow-inner @else hover:bg-white/10 @endif focus:outline-none focus:ring-0" :class="sidebarCollapsed ? 'justify-center px-3' : 'gap-3 px-4'" @if(request()->routeIs('rd.leaves*')) aria-current="page" @endif title="Leave Requests">
        ...
        <a href="{{ route('rd.downloads') }}" class="flex items-center rounded-xl py-3 text-lg transition @if(request()->routeIs('rd.downloads')) bg-white/10 shadow-inner @else hover:bg-white/10 @endif focus:outline-none focus:ring-0" :class="sidebarCollapsed ? 'justify-center px-3' : 'gap-3 px-4'" @if(request()->routeIs('rd.downloads')) aria-current="page" @endif title="Download">
        ...
        <a href="{{ route('rd.help') }}" class="flex items-center rounded-xl py-3 text-lg transition @if(request()->routeIs('rd.help')) bg-white/10 shadow-inner @else hover:bg-white/10 @endif focus:outline-none focus:ring-0" :class="sidebarCollapsed ? 'justify-center px-3' : 'gap-3 px-4'" @if(request()->routeIs('rd.help')) aria-current="page" @endif title="Help & Support">
