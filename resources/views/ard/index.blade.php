                ...
                <section class="p-4 sm:p-6 lg:p-8">
                    <div class="bg-white border-t border-gray-100 rounded-none p-6 sm:p-8 shadow-none">
                        <div class="flex flex-col sm:flex-row items-start sm:items-end sm:justify-start gap-3">
                            <div>
                                <h1 class="text-2xl sm:text-3xl font-semibold text-gray-800 tracking-tight">ARD Dashboard</h1>
                            ...
                            <div class="flex gap-2">
                                <a href="{{ route('ard.leaves') }}" class="inline-flex items-center gap-2 px-4 py-2 rounded-lg bg-indigo-600 text-white shadow hover:bg-indigo-700 transition">
                            ...
                            <div class="group rounded-xl border border-gray-200 bg-white p-5 shadow-sm hover:shadow transition">
                                <div class="flex items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <div class="text-22l font-semibold text-gray-900">{{ $stats['pending'] }}</div>
                                    </div>
                                </div>
                            </div>
                            <div class="group rounded-xl border border-gray-200 bg-white p-5 shadow-sm hover:shadow transition">
