...
class RdController extends Controller
{
    public function index()
    {
        ...
        return view('rd.index', compact('stats'));
    }
    ...
    public function leaves(Request $request)
    {
        ...
        return view('rd.leaves', compact('leaves'));
    }
    ...
    public function downloads(Request $request)
    {
        ...
        return view('staff.approved_downloads', [
            'leaves' => $leaves,
            'sidebarPartial' => 'rd.partials.sidebar',
    ...
    public function showLeave(Leave $leave)
    {
        ...
        return view('rd.leave_show', compact('leave'));
    }
    ...
    public function saveRecommendation(Request $request, Leave $leave)
    {
        ...
        $details['rd_recommendation'] = $payload;
